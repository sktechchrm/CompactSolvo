...
const EmploymentSchema = z.object({
  ...
  attbonus:             z.string().min(1, 'হাজিরা বোনাস আবশ্যক'),
...
function EmploymentStep({ formData, handleInputChange, setFormData, onDirtyChange }: EmployeeFormProps) {
  useStepForm(EmploymentSchema, {
    ...
    attbonus: formData.attbonus, jobSource: formData.jobSource,
    ...
    <div>
      ...
      <div style={card}>
        ...
        <div style={g4}>
          ...
          <FormField label="হাজিরা বোনাস" id="ef-attbonus" required>
            <Input {...inp('attbonus','number','হাজিরা বোনাস')} aria-required={true} />
          </FormField>
