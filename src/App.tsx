...
const WorkerGuidelineViewer = lazy(
  () => import('./components/workerGuideline/WorkerGuidelineViewer')
);
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        />
        <Route
          path="/worker-guide/:factoryId/view"
          element={
            <S>
              <WorkerGuidelineViewer />
            </S>
          }
        />
        ...
        >
          ...
          <Route
            path="/worker-rights"
            element={
              <M module="workerrights">
                <WorkerRights />
              </M>
            }
          />
          <Route
            path="/worker-guideline/:factoryId"
            element={
              <S>
                <WorkerGuidelineViewer />
              </S>
